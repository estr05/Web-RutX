...
<div wire:poll.{{ $pollInterval }}s>
    ...
    <form wire:submit="consultar">
        <x-filter-bar>
            ...
            <div>
                <label for="rentabilidad-date-from" class="block text-xs font-semibold text-rutx-text-muted mb-1">Desde</label>
                <input
                    id="rentabilidad-date-from"
                    type="date"
                    wire:model="dateFrom"
            ...
            <div>
                <label for="rentabilidad-date-to" class="block text-xs font-semibold text-rutx-text-muted mb-1">Hasta</label>
                <input
                    id="rentabilidad-date-to"
                    type="date"
                    wire:model="dateTo"
                    class="h-[var(--rutx-height-input)] border border-rutx-border rounded-lg bg-rutx-surface-grey px-3 text-sm
                           focus:ring-2 focus:ring-rutx-primary focus:border-rutx-primary outline-none transition-shadow"
